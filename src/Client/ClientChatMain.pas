...
procedure TFrmClientChat.BuildClient;
begin
...
procedure TFrmClientChat.Log(const AMessage: String);
begin
...
{ Traduz o protocolo JSON do chat. Mensagens fora do protocolo são exibidas
  como texto puro. }
procedure TFrmClientChat.ShowIncoming(const AMessage: String);
var
  LJSON: TJSONObject;
  LType: String;
  LText: String;
...
procedure TFrmClientChat.UpdateInterface;
var
  LConnected: Boolean;
begin
...
procedure TFrmClientChat.Connect;
var
  LHost: String;
  LPort: Word;
  LPosition: Integer;
...
procedure TFrmClientChat.Disconnect;
begin
  FClient.Disconnect;
  UpdateInterface;
end;

procedure TFrmClientChat.BtnConectarClick(Sender: TObject);
begin
  try
...
procedure TFrmClientChat.BtnEnviarClick(Sender: TObject);
var
  LTarget: String;
  LText: String;
begin
...
procedure TFrmClientChat.BtnPingClick(Sender: TObject);
begin
  try
    FClient.Ping;
    Log('Ping enviado.');
...
procedure TFrmClientChat.EdtMensagemKeyPress(Sender: TObject; var Key: Char);
begin
